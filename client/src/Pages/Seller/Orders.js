...
const Orders = () => {
    ...
    useEffect(()=>{
        showLoading();
        axios.get(geturl() + '/seller/user/'+getusername())
        .then((res)=>{
            axios.get(geturl() + '/order/seller/'+ res.data.store.storeid)
                .then((res)=>{
                    swal.close();
    ...
    async function delivered_api(orderid){
        ...
        axios.get(geturl() + '/order/'+ orderid)
            .then((res)=>{
                swal.close();
                const  order = {
                ...
                if(res.data.status === "Delived"){
                    ...
                    const url = geturl() + '/order/update/'+orderid;
